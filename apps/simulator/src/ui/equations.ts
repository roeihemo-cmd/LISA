...
export const EQ: Record<string, Eq> = {
  braking: {
    ...
    sub: {
      en: 'The total distance the system needs to stop safely.',
      he: 'מרחק העצירה הכולל שהמערכת זקוקה לו כדי לעצור בבטחה.',
    },
    terms: [
      [{ en: 'V — Speed', he: 'V — מהירות' }, { en: 'The vehicle current speed, in metres per second.', he: 'מהירות הרכב הנוכחית, במטר לשנייה.' }],
      [{ en: 'T — Total latency', he: 'T — השהיה כוללת' }, { en: 'T_dsp + T_flt + T_act: DSP, matched filter, brake actuator. During this time the car still travels at full speed (the "blind" distance).', he: 'T_dsp + T_flt + T_act: עיבוד אות, מסנן מותאם, ומפעיל הבלם. בזמן הזה הרכב עדיין נוסע במלוא המהירות (מרחק "עיוור").' }],
      [{ en: 'μ·g — Deceleration', he: 'μ·g — האטה' }, { en: 'Friction coefficient times gravity — the maximum deceleration.', he: 'מקדם החיכוך כפול תאוצת הכובד — ההאטה המרבית.' }],
      [{ en: 'V²/(2μg) — Mechanical', he: 'V²/(2μg) — מרחק מכני' }, { en: 'The net braking distance once the brakes bite.', he: 'מרחק הבלימה נטו מרגע שהבלמים תופסים.' }],
