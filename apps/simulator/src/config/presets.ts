...
export const SCENARIOS: Record<string, ScenarioConfig> = {
  cutin: {
    ...
    challenge: { en: 'A car from the adjacent lane cuts in — detect it and slow/follow at once.', he: 'רכב מהנתיב הסמוך נכנס לפנינו — לזהות ולהאט/לעקוב מיד.' }, eqs: ['ttc', 'braking'],
  },
  hardBrake: {
  ...
  child: {
    ...
    challenge: { en: 'A child and ball cross at very short range — emergency braking.', he: 'ילד + כדור חוצים בטווח קצר מאוד — בלימת חירום.' }, eqs: ['lidar', 'ttc', 'braking'],
  },
  fog: {
    ...
    challenge: { en: 'A stalled car in heavy fog — Beer–Lambert limits the detection range.', he: 'רכב תקוע בערפל כבד — Beer-Lambert מגביל את טווח הגילוי.' }, eqs: ['beer', 'lidar', 'braking'],
  },
  roadworks: {
